...
import 'package:pascoa_scout_client/src/protocol/entities/upwork_scrap/pagination.dart'
    as _i7;
import 'package:pascoa_scout_client/src/protocol/greetings/greeting.dart'
    as _i8;
...
/// {@category Endpoint}
class EndpointUpworkJobs extends _i2.EndpointRef {
  EndpointUpworkJobs(_i2.EndpointCaller caller) : super(caller);

  @override
  String get name => 'upworkJobs';

  _i3.Future<List<_i5.JobInfo>> getJobs(
    _i6.JobFilter filter,
    _i7.Pagination? pagination,
  ) => caller.callServerEndpoint<List<_i5.JobInfo>>(
    'upworkJobs',
    'getJobs',
    {
      'filter': filter,
