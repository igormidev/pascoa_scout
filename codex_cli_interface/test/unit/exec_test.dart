...
import 'package:codex_cli_interface/src/exceptions.dart';
import 'package:codex_cli_interface/src/exec.dart';
import 'package:codex_cli_interface/src/options.dart';
...
void main() {
  group('CodexExec', () {
    test('builds expected args and env and forwards stdin', () async {
      ...
      expect(forwardedArgs.take(2), <String>['exec', '--json']);
